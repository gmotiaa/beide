...
interface PixelCardProps {
    ...
    label?: LabelGroup
    style?: CSSProperties
    /** Vendored addition: real card content drawn over the pixel canvas. */
    children?: ReactNode
    /** Vendored addition: layout of the content layer (default centres it). */
...
export default function PixelCard(props: PixelCardProps) {
    ...
    const initPixels = () => {
        ...
        // can read 0 at setup, leaving an empty grid. Fall back to the container
        // so the card always fills the frame.
    ...
    // Export/thumbnail → one static frame. Otherwise wait for hover.
    const present = () => {
